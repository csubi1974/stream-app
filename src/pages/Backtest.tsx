...
export function Backtest() {
    ...
    useEffect(() => {
        ...
        setDbStats({
            ...
            activeSymbols: ['SPX'],
            dbSize: '12 KB',
            lastSnapshot: 'Waiting for market data...'
        });
    }, []);
        ...
        <div className="min-h-screen bg-gray-900">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="mb-8">
                    ...
                    <p className="text-gray-400">Manage historical data and run strategy simulations</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    ...
                    <div className="bg-gray-800 rounded-lg p-6 border border-green-500/30">
                        ...
                        <div className="space-y-3">
                            <div className="flex justify-between text-sm">
                                ...
                                <span className="text-white font-mono">SPX Option Chain</span>
                            </div>
                            <div className="flex justify-between text-sm">
                            ...
                            <div className="mt-4 pt-4 border-t border-gray-700">
                                ...
                                <div className="text-xl font-bold text-white">Recording...</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-gray-800 rounded-lg p-6">
                        ...
                        <div className="space-y-4">
                            <div className="bg-gray-700/50 rounded p-3">
                                <div className="text-gray-400 text-xs mb-1">Total Snapshots</div>
                                <div className="text-2xl font-bold text-white">{dbStats?.totalSnapshots || 0}</div>
                            </div>
                            <div className="flex justify-between text-sm text-gray-400">
                                <span>DB Size: {dbStats?.dbSize}</span>
                                <span>Symbol: {dbStats?.activeSymbols.join(', ')}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-gray-800 rounded-lg p-6">
                        ...
                        <p className="text-sm text-gray-400 mb-6">
                            Replay historical market conditions to test your strategies.
                        </p>
                ...
                <div className="bg-gray-800 rounded-lg p-6">
                    ...
                    <div className="text-center py-12 border-2 border-dashed border-gray-700 rounded-lg">
                        ...
                        <p className="text-gray-400">Waiting for first recording cycle...</p>
                        <p className="text-sm text-gray-500 mt-2">Data is recorded every 5 minutes while market is open.</p>
                    </div>
                </div>
            </main>
        </div>
