    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-400">Configure your tape reading platform preferences</p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm text-gray-400 mb-2">
                Sweep Alert Threshold (contracts)
              </label>
              <input
                type="number"
            ...
            <div>
              ...
              >
                ...
                <option value={250}>250ms (Medium)</option>
          ...
          <div className="flex items-center space-x-6 mt-4">
            <label className="flex items-center">
              <input
                ...
                className="mr-2"
              />
              <span className="text-gray-300">Enable Sound Alerts</span>
            </label>
            ...
            <label className="flex items-center">
              <input
                ...
                className="mr-2"
              />
              <span className="text-gray-300">Enable Visual Alerts</span>
            </label>
          </div>
        </div>
        ...
        <div className="bg-gray-800 rounded-lg p-6 mb-6">
          ...
          <div className="space-y-4">
            ...
            <div className="text-xs text-gray-500">
              ⚠️ Your API credentials are stored locally and never sent to our servers.
            </div>
            ...
            <div className="mt-4 flex items-center justify-between">
              ...
              <span className={schwabConnected ? 'text-green-400' : 'text-red-400'}>
                {schwabConnected ? 'Conectado' : 'Desconectado'}
              </span>
            </div>
            ...
            <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="md:col-span-1">
                <label className="block text-sm text-gray-400 mb-2">Código (code)</label>
                <input
                  type="text"
                  value={codeInput}
                  onChange={(e) => setCodeInput(e.target.value)}
                  className="w-full bg-gray-700 text-white px-3 py-2 rounded border border-gray-600 focus:border-blue-500 focus:outline-none"
                  placeholder="Pega el parámetro code"
                />
              </div>
              <div className="md:col-span-1">
                <label className="block text-sm text-gray-400 mb-2">URL de redirección completa</label>
                <input
                  type="text"
                  value={redirectInput}
            ...
            <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="md:col-span-1">
                ...
                <input
                  ...
                  className="w-full bg-gray-700 text-white px-3 py-2 rounded border border-gray-600 focus:border-blue-500 focus:outline-none"
                  placeholder="Pega tu access_token"
                />
              </div>
              <div className="md:col-span-1">
          ...
          <div className="flex items-center space-x-6">
            <label className="flex items-center">
              <input
                ...
                className="mr-2"
              />
              <span className="text-gray-300">Show Greeks</span>
            </label>
            ...
            <label className="flex items-center">
              <input
                ...
                className="mr-2"
              />
              <span className="text-gray-300">Show Volume Profile</span>
            </label>
