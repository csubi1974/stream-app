# Stream App - Version 1.5 - Nuevas Funcionalidades GEX

## 🚀 Resumen de Actualización v1.5

Esta versión introduce un sistema completo de análisis GEX (Gamma Exposure) institucional con 6 nuevas métricas avanzadas que permiten entender el régimen de volatilidad del mercado y la posición de los dealers.
